...
export const REGIONS = new Map<string, Region>([
    [REGIONS_IDS.USWest1, {
        ...
        cwClient: new CloudWatchClient({ region: REGIONS_IDS.USWest1 }),
    ...
    [REGIONS_IDS.USEast1, {
        ...
        cwClient: new CloudWatchClient({ region: REGIONS_IDS.USEast1 }),
    ...
    [REGIONS_IDS.EUNorth1, {
        ...
        cwClient: new CloudWatchClient({ region:REGIONS_IDS.EUNorth1 }),
    ...
    [REGIONS_IDS.EUCentral1, {
        ...
        cwClient: new CloudWatchClient({ region: REGIONS_IDS.EUCentral1 }),
    ...
    [REGIONS_IDS.APSouth1, {
        ...
        cwClient: new CloudWatchClient({ region: REGIONS_IDS.APSouth1 }),
